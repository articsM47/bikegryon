...
//form_file($name, $label) Renders a form file box
 ...
 return page_with_title("Import Data", array(
  ...
  div('row', array(
          div('col-md-12', array(
              form(array(
                form_file('csv_file', _("Import product data from a csv file")),
                form_submit('uploadcsv', _("Import"))
              )),
              form(array(
                form_file('json_file', _("Import product data from a json file")),
                form_submit('uploadjson', _("Import"))
              ))
          ))
      ))
  ));
