    ...
    <body>
      <div id="login-block">
        <form class="form-signin">
          ...
          <a href="/artics/Confirmation" type="button" class="form-option-text login">Tu as oublié ton mot de passe? </a>
          <button id="submit-account" type="submit"><span>Se connecter</span></button>
          <div class="form-group text-center ">
            <a href="/artics/Login" type="button" class="form-option-text">Je n’ai pas encore de compte</a>
          </div>
        </form>
    </body>
  </div>
