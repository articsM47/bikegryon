...
<div class="container">
    ...
    <div class="container">
        ...
        <input class="form-control" type="text" name="fullname" value="{{$nom ?? old('fullname')}} {{$prenom ?? ''}}" readonly>
        <input class="form-control" type="text" name="birthday" value="{{$birthday ?? old('birthday')}}" readonly>
...
<div class="form-group text-center ">
    <input class="btn btn-primary btn-lg" type="submit" value="Continuer">
    <a href="/Catalogue" type="button" class="badge badge-light">continuer sans compte</a>
</div>
<div class="form-group text-center ">
